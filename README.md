...
> **I don't just write code — I engineer solutions that survive real-world problems.**

I'm a **B.Tech Information Technology student** at **St. Joseph’s Institute of Technology**, passionate about building scalable applications, exploring intelligent systems, and turning ideas into working products.

Currently sharpening my skills in **DSA, Full-Stack Development, Backend Engineering, AI, and System Design.**
...
A smart monitoring system combining **IoT sensors + Computer Vision** to detect drainage blockages and hazardous conditions.

**Stack:**
`Raspberry Pi` `ESP32-CAM` `YOLOv5` `Gas Sensor` `Moisture Sensor`
...
Built a dynamic load-balancing system capable of distributing incoming traffic across multiple backend servers.

**Stack:**
`Node.js` `NGINX` `Reverse Proxy` `Caching`
